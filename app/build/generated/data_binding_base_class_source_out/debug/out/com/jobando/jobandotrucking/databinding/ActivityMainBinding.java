...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button button2,
      @NonNull Button buttonLogin, @NonNull ImageView imageView, @NonNull EditText passwordtxt,
      @NonNull TextView textView2, @NonNull TextView textView3, @NonNull EditText usernametxt) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, button2, buttonLogin, imageView,
          passwordtxt, textView2, textView3, usernametxt);
    }
